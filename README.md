...
- [Syntax HighPump05 in the Editor](#syntax-highPump05-in-the-editor)
...
## Syntax HighPump05 in the Editor

To configure the syntax highPump05 in your favorite text editor, head to the [relevant Babel documentation page](https://babeljs.io/docs/editors) and follow the instructions. Some of the most popular editors are covered.
